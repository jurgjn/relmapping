...
rule atac814_prp: # snakemake --use-conda --cores 12 -s sample_prp.snakefile atac814_prp --dryrun
    input:
        expand(pf('atac814_{sample}_prp1', 'tg_pe.bwa_pe.rm_unmapped_pe.rm_chrM.rm_blacklist.rm_q10', '.bam', 'atac814'), sample=config['stages_wt']),
        expand(pf('atac814_{sample}_prp2', 'tg_pe.bwa_pe.rm_unmapped_pe.rm_chrM.rm_blacklist.rm_q10', '.bam', 'atac814'), sample=config['stages_wt']),
        expand(pf('atac814_{sample}_prp1', 'tg_se.bwa_se.rm_unmapped.rm_chrM.rm_blacklist.rm_q10', '.bam', 'atac814'), sample=config['stages']),
        expand(pf('atac814_{sample}_prp2', 'tg_se.bwa_se.rm_unmapped.rm_chrM.rm_blacklist.rm_q10', '.bam', 'atac814'), sample=config['stages']),
